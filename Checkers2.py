...
class Checkers:
    ...
    def decode_encoded_state(self, encoded_state, player, ver=2):
        """
        ...
        - ver: Encoding version (must match encoding version used).
        ...
        if ver == 1:
            board = np.zeros((self.row_count, self.col_count), dtype=int)
            board[encoded_state[0] == 1] = -2  # King of player -1
            board[encoded_state[1] == 1] = -1  # Normal piece of player -1
            board[encoded_state[2] == 1] = 1   # Normal piece of player 1
            board[encoded_state[3] == 1] = 2   # King of player 1
        else:
            board = (encoded_state / player).astype(int)  # Reverse multiplication by player
